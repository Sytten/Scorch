========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet scorch_iteration_01
========================================================================

AppWizard a créé cette application scorch_iteration_01 pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application scorch_iteration_01.


scorch_iteration_01.vcxproj
...
scorch_iteration_01.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) scorch_iteration_01.pch et un fichier de type précompilé nommé StdAfx.obj.
